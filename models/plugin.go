...
type Plugin struct {
	...
	DeveloperID    string         `gorm:"type:varchar(255);not null;index" json:"developer_id"`
	...
	ScanResult     string         `gorm:"type:text" json:"scan_result,omitempty"` // JSON des résultats d'analyse
